...
public class Maze {
    ...
    /**
     * This method resets the maze to the way it was beforehand
     * @param maze the maze to be reset
     */
    public static void resetMaze(int[][] maze) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(exitMaze(maze, 0, 0)); //Goes through the maze starting in the top left looking for an entrance and a way to the exit
    }
}
